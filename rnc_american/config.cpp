...
class CfgEditorCategories {
	class rnc_american { // Category class, you point to it in editorCategory property
		displayName = "American Objects (R&C)"; // Name visible in the list
	};
};
...
class CfgVehicles {
	...
	class american_parts: House_Small_F {
		scope = 2;
		displayName = "American Household Parts";
		model = "rnc_american\american_parts.p3d";

		editorCategory = "rnc_american";
