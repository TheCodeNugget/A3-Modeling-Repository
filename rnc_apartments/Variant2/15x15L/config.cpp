...
class CfgPatches {
	class rnc_apartments_variant2_15x15L {
		...
		units[] = {
			...
			//"Land_rnc_apt_v2_15x15L_c2_f3",
			//"Land_rnc_apt_v2_15x15L_c2_f4",
			//"Land_rnc_apt_v2_15x15L_c2_f5",
			//"Land_rnc_apt_v2_15x15L_c2_f6"
		};
		weapons[] = {};
	};
};
class CfgVehicles {
	...
	class Land_rnc_apt_v2_15x15L_c1_f5: Land_rnc_apt_v2_15x15L_c1_f3{
		displayName = "Apartment V2/15x15L/C1/F5";
		model = "rnc_apartments\variant2\15x15L\rnc_apt_v2_15x15L_c1_f5.p3d";
	};

	class Land_rnc_apt_v2_15x15L_c1_f6: Land_rnc_apt_v2_15x15L_c1_f3{
