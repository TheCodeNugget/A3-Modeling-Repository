...
class CfgVehicles {
	...
	class Land_rnc_apt_v1_15x15L_c1_f3: rnc_house_base {
		...
		editorSubCategory = "rnc_v1_15x15L";
		...
		class Hitpoints {
			...
			NORMAL_GLASS_HITPOINT(25,0.001,0.1);
			NORMAL_GLASS_HITPOINT(26,0.001,0.1);
			NORMAL_GLASS_HITPOINT(27,0.001,0.1);
			NORMAL_GLASS_HITPOINT(28,0.001,0.1);
			NORMAL_GLASS_HITPOINT(29,0.001,0.1);
			NORMAL_GLASS_HITPOINT(30,0.001,0.1);
			NORMAL_GLASS_HITPOINT(31,0.001,0.1);
			NORMAL_GLASS_HITPOINT(32,0.001,0.1);
		};
		...
		class AnimationSources {
			...
			class glass_25_source : glass_1_source { hitpoint = "glass_25_hitpoint"; };
			class glass_26_source : glass_1_source { hitpoint = "glass_26_hitpoint"; };
			class glass_27_source : glass_1_source { hitpoint = "glass_27_hitpoint"; };
			class glass_28_source : glass_1_source { hitpoint = "glass_28_hitpoint"; };
			class glass_29_source : glass_1_source { hitpoint = "glass_29_hitpoint"; };
			class glass_30_source : glass_1_source { hitpoint = "glass_30_hitpoint"; };
			class glass_31_source : glass_1_source { hitpoint = "glass_31_hitpoint"; };
			class glass_32_source : glass_1_source { hitpoint = "glass_32_hitpoint"; };
		};
	...
	class Land_rnc_apt_v1_15x15L_c1_f4: rnc_house_base {
		scope = 2;
		...
		class Hitpoints {
			...
			NORMAL_GLASS_HITPOINT(31,0.001,0.1);
			NORMAL_GLASS_HITPOINT(32,0.001,0.1);
			NORMAL_GLASS_HITPOINT(33,0.001,0.1);
			NORMAL_GLASS_HITPOINT(34,0.001,0.1);
			NORMAL_GLASS_HITPOINT(35,0.001,0.1);
			NORMAL_GLASS_HITPOINT(36,0.001,0.1);
		};
		...
		class AnimationSources {
			...
			class glass_31_source : glass_1_source { hitpoint = "glass_31_hitpoint"; };
			class glass_32_source : glass_1_source { hitpoint = "glass_32_hitpoint"; };
			class glass_33_source : glass_1_source { hitpoint = "glass_33_hitpoint"; };
			class glass_34_source : glass_1_source { hitpoint = "glass_34_hitpoint"; };
			class glass_35_source : glass_1_source { hitpoint = "glass_35_hitpoint"; };
			class glass_36_source : glass_1_source { hitpoint = "glass_36_hitpoint"; };
		};
		...
		class UserActions {
			...
			class openDoor_5 {
				...
				aiMaxRange = 5.25;
				onlyForPlayer = false; // Defines if the action is available only to players or AI as well.
				condition = (this animationPhase 'Door_5_rot') < 0.5; // Condition for showing the action in action menu. In this case it checks if the door is closed and if the part of the house in which the door is located hasn't been destroyed yet).
				statement = ([this, 'Door_5_rot'] call BIS_fnc_DoorNoHandleOpen); // Action taken when this action is selected in the action menu. In this case it calls a function that opens the door.
			};
			class closeDoor_5: openDoor_4 {
				displayName = "$STR_DN_OUT_C_DOOR";
				priority = 0.2;
			...
			class openDoor_6 {
				...
				aiMaxRange = 5.25;
				onlyForPlayer = false; // Defines if the action is available only to players or AI as well.
				condition = (this animationPhase 'Door_6_rot') < 0.5; // Condition for showing the action in action menu. In this case it checks if the door is closed and if the part of the house in which the door is located hasn't been destroyed yet).
				statement = ([this, 'Door_6_rot'] call BIS_fnc_DoorNoHandleOpen); // Action taken when this action is selected in the action menu. In this case it calls a function that opens the door.
			};
